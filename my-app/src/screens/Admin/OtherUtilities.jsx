        ...
        <div className="other-utilities">
            <div className="page-header">
                <div className="header-content">
                    ...
                    <p className="page-subtitle">Xuất giấy mời từ template và danh sách tên trong Excel</p>
                </div>
            </div>

            <div className="utility-card">
                <h2 className="utility-title">Xuất giấy mời hàng loạt</h2>
                ...
                <div className="canva-link-box">
                    ...
                    <p className="canva-link-note">
                        Cách lấy link: Canva → Share/Chia sẻ → Copy link.
                    </p>
                </div>
                ...
                <div className="templates-grid">
                    <div className="form-group">
                        ...
                        {templateSize.width > 0 && (
                            <p className="file-name">Kích thước: {templateSize.width} × {templateSize.height}px</p>
                        )}
                    </div>
                </div>
                ...
                >
                    {generating ? 'Đang xuất...' : 'Xuất giấy mời từ template Canva (.zip)'}
                </button>
            </div>
        </div>
    );
